...
public class DetailMgmt extends JFrame {
	 ...
	 * @throws SQLException
	 */
	public DetailMgmt() throws SQLException {
		...
		setTitle("UsesDetail Management");
		...
		btnAdd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				new AddDetail(b, DetailMgmt.this).setVisible(true);
			}
		});
		...
		btnEdit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				new EditDetail(b, DetailMgmt.this).setVisible(true);
			}
		});
		...
		btnSearch.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				new SearchDetail(b, DetailMgmt.this).setVisible(true);
			}
		});
		...
		JLabel lblNewLabel = new JLabel("USESDETAIL MANAGEMENT");
